    ...
    protected Void doInBackground() throws Exception
    {
    	...
    	try {
            ...
            Process youtube_dl = rt.exec(
             	currentPath + File.separator + "youtube-dl.exe --newline --write-thumbnail --write-auto-sub --write-sub --sub-format vtt -o " + newdir + " -f bestvideo[ext=mp4]+bestaudio[ext=m4a]/bestvideo+bestaudio " + url
             	);
